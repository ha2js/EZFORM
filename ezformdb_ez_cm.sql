...
CREATE TABLE `ez_cm` (
  ...
  `cm_enum` int(11) NOT NULL,
  `cm_dname` varchar(45) NOT NULL,
  `cm_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `cm_hits` int(11) DEFAULT '0',
  `cm_like` int(11) DEFAULT '0',
  `cm_file` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`cm_bnum`)
