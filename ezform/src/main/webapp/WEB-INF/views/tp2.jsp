...
<html>
  ...
  <body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="header" style="background: url('resources/images/dashboard/top-image.jpg'); background-size: cover; background-repeat: no-repeat; height: 100vh;position: relative;">
        <div class="main-img">
            <div class="container">
...
&#x3C;/div&#x3E;
    ...
    <script src="resources/js/app.js"></script>
        <script src="resources/js/prism.mini.js"></script>
  </body>
</html>