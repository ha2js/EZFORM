                  ...
                  <div class="card-body">
                     <div class="new-user-info">
                        <form role="form" action="" method="get">
                           ...
                           <input type="button" class="btn btn-primary" id="btn-update" value="회원수정" onclick="location.href='updateMember';"/>
                           <input type="button" class="btn btn-primary" id="btn-delete" value="회원탈퇴" onclick="location.href='deleteMember';"/>
