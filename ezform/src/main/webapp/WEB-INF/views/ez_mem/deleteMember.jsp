	...
	<%
		...
		if(result != null) {
			if(result.equals("0")) {
				%>
				<script>
					alert("회원탈퇴 실패하셨습니다. 비밀번호를 제대로 다시 입력해주세요.");
                  	...
                  	<form role="form" action="./deleteMember" method="post"  enctype="multipart/form-data"  onsubmit="return emp_join_avail();">
                        <div class="form-group">
                           <div class="profile-img-edit position-relative">
                              <img class="profile-pic rounded avatar-100" src="${pageContext.request.contextPath }/resources/upload/mem_Image/${resultVO.em_image}" alt="profile-pic">
                              <div class="upload-icone bg-primary">
                                 <svg class="upload-button" width="14" height="14" viewBox="0 0 24 24">
                                    <path fill="#ffffff" d="M14.06,9L15,9.94L5.92,19H5V18.08L14.06,9M17.66,3C17.41,3 17.15,3.1 16.96,3.29L15.13,5.12L18.88,8.87L20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18.17,3.09 17.92,3 17.66,3M14.06,6.19L3,17.25V21H6.75L17.81,9.94L14.06,6.19Z" />
                                 </svg>
                                 <input class="file-upload" type="file" id="file" name="em_image" accept="image/gif, image/jpeg, image/png" onchange="fileCh(this);" readonly/>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="new-user-info">
						   ...
						   <input type="submit" class="btn btn-primary" id="btn-update" value="탈퇴"/>
