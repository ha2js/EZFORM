...
$(document).ready(function(){
	<!-- 근태이미지 경로 -->
/* 	var icon1 = '<img src="../../resources/images/wstatus/dot_blue.png">';
	var icon2 = '<img src="../../resources/images/wstatus/dot_bk.png">';
	$(function(){
			var icon_val =$('#wstatus_icon').text();
			//alert(${status.count}+icon_val);   // 1 2 3.. 차례로 팝업
		    			          
			
					if($('#wstatus_icon').text() == '출근')  $('#wstatus_icon').val(icon1);
					if($('#wstatus_icon').text() == '퇴근')  $('#wstatus_icon').html(icon2);
	});	 */
  ...
  <% 	 //session제어
	...
	//	EZ_empVO empvo = (EZ_empVO) session.getAttribute("empvo");
%>
    <!-- loader Start -->
    <div id="loading">
...
<%} %>                            
                            <li class="nav-item">
                                <a class="nav-link" href="/emp/joins">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> R </i>
                                    <span class="item-name">직원등록</span>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="/emp/list">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <i class="sidenav-mini-icon"> U </i>
                                    <span class="item-name">직원 리스트</span>
                                </a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto  navbar-list mb-2 mb-lg-0">
                 <li class="nav-item dropdown">
                    ...
                    <img src="../../resources/images/Flag/flag001.png" class="img-fluid rounded-circle" alt="user" style="height: 30px; min-width: 30px; width: 30px;">
                        ...
                        <div class="card shadow-none m-0 border-0">
                            <div class=" p-0 ">
                                <ul class="list-group list-group-flush p-0">
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="../../resources/images/Flag/flag-03.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Spanish</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="../../resources/images/Flag/flag-04.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Italian</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="../../resources/images/Flag/flag-02.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>French</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="../../resources/images/Flag/flag-05.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>German</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="../../resources/images/Flag/flag-06.png" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Japanese</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body p-0">
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="../../resources/images/shapes/01.png" alt="">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <div class="">
                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="../../resources/images/shapes/02.png" alt="">
                                  </div>
                                  <div class="ms-3 w-100">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="../../resources/images/shapes/03.png" alt="">
                                  <div class="ms-3 w-100">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="../../resources/images/shapes/04.png" alt="">
                      ...
                      <div class="card shadow-none m-0">
                        ...
                        <div class="card-body p-0 ">
                            ...
                            <a href="#" class="iq-sub-card">
                              <div class="d-flex align-items-center">
                                  <div class="">
                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="../../resources/images/shapes/05.png" alt="">
                                  </div>
                                  <div class="ms-3">
...
<!-- 로그인직원 표시 -->                
                <li class="nav-item dropdown">
                  <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../../resources/images/avatars/01.png" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded">
                    <div class="caption ms-3 d-none d-md-block ">
                        <h6 class="mb-0 caption-title">${empvo.em_name }</h6>
                        <p class="mb-0 caption-sub-title">${empvo.em_dept }</p>
                    </div>
                  </a>
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="/emp/logout">Logout</a></li>
                  </ul>
                </li>
              </ul>
            </div>
          ...
          <div class="iq-navbar-header" style="height: 215px;">
              ...
              <div class="iq-header-img">
                  <img src="../../resources/images/dashboard/top-header.png" alt="header" class="img-fluid w-100 h-100 animated-scaleX">
              </div>
      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">직원 전체목록</h4>
               </div>
            </div>
           		...
           		<!--       <th>근태</th>    -->                        
					 ...
					 <tbody>                     
					     <c:forEach  var="empList"   items="${empList }" varStatus="status">
							<tr>						
	<%-- 						<td>
								 <span id="wstatus_icon">
									${empList.ez_workVO.work_status}
								 </span>									
								</td> --%>
								<td>${empList.em_id }</td>
...
<%-- 								<td>${empList.ez_workVO.work_regdate}</td> --%>
								 ...
								 <td>
	                              ...
	                              <form action="/emp/update">
	                                 <a class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="/emp/update?em_id=${empList.em_id }">
	                                    <span class="btn-inner">
	                                       <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	                              ...
	                              <form action="/emp/delete" method="post">
	                              	<input type="hidden" value="${empList.em_id }" name="em_id">
	                              	<input type="hidden" value="${empList.em_pw }" name="em_pw">
	                                   <button id="btn-delete" type="submit" class="btn btn-sm btn-icon btn-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
	                                    <span class="btn-inner">
...
<!--                      <tbody>
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../resources/images/shapes/01.png" alt="profile"></td>
                           <td>Anna Sthesia</td>
                           <td>(760) 756 7568</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../resources/images/shapes/02.png" alt="profile"></td>
                           <td>Brock Lee</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../resources/images/shapes/03.png" alt="profile"></td>
                           <td>Dan Druff</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../resources/images/shapes/04.png" alt="profile"></td>
                           <td>Hans Olo</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../resources/images/shapes/05.png" alt="profile"></td>
                           <td>Lynn Guini</td>
                        ...
                        <tr>
                           <td class="text-center"><img class="bg-soft-primary rounded img-fluid avatar-40 me-3" src="../../resources/images/shapes/06.png" alt="profile"></td>
                           <td>Eric Shun</td>
          ...
          <div class="col-lg-12">
            ...
            <div class="d-grid gap-x-3 grid-cols-2 mb-4">
              <div class="text-center">
                <img src="../../resources/images/settings/dark/01.png" alt="ltr" class="mode dark-img img-fluid btn-border p-0 flex-column active" data-setting="dir-mode" data-name="dir" data-value="ltr">
                <img src="../../resources/images/settings/light/01.png" alt="ltr" class="mode light-img img-fluid btn-border p-0 flex-column active" data-setting="dir-mode" data-name="dir" data-value="ltr">
                <span class=" mt-2"> LTR </span>
              </div>
               <div class="text-center">
                 <img src="../../resources/images/settings/dark/02.png" alt="" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="dir-mode" data-name="dir" data-value="rtl">
                  <img src="../../resources/images/settings/light/02.png" alt="" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="dir-mode" data-name="dir" data-value="rtl">
            ...
            <div class="d-grid gap-x-3 grid-cols-3 mb-4">
              <div class="text-center">
                <img src="../../resources/images/settings/dark/03.png" alt="mini" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                <img src="../../resources/images/settings/light/03.png" alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                <span class="mt-2">Mini</span>
              </div>
              <div class="text-center">
               <img src="../../resources/images/settings/dark/04.png" alt="hover" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
               <img src="../../resources/images/settings/light/04.png" alt="hover" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-hover" data-extra-value="sidebar-mini">
                <span class="mt-2">Hover</span>
              </div>
              <div class="text-center">
                 <img src="../../resources/images/settings/dark/05.png" alt="boxed" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
                 <img src="../../resources/images/settings/light/05.png" alt="boxed" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-boxed">
            ...
            <div class="d-grid gap-x-3 grid-cols-2 mb-4">
              <div class="mb-4 text-center">
                <img src="../../resources/images/settings/dark/06.png" alt="rounded-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                <img src="../../resources/images/settings/light/06.png" alt="rounded-one-side" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded">
                <span class="mt-2">Rounded One Side</span>
              </div>
              <div class="mb-4 text-center">
                <img src="../../resources/images/settings/dark/07.png" alt="rounded-all" class="mode dark-img img-fluid btn-border p-0 flex-column active" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                <img src="../../resources/images/settings/light/07.png" alt="rounded-all" class="mode light-img img-fluid btn-border p-0 flex-column active" data-setting="sidebar" data-name="sidebar-item" data-value="navs-rounded-all">
                <span class="mt-2">Rounded All</span>
              </div>
              <div class="mb-4 text-center">
                 <img src="../../resources/images/settings/dark/09.png" alt="pill-one-side" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                 <img src="../../resources/images/settings/light/09.png" alt="pill-one-side" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                <span class="mt-2">Pill One Side</span>
              </div>
              <div class="mb-4 text-center">
                 <img src="../../resources/images/settings/dark/08.png" alt="pill-all" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
                 <img src="../../resources/images/settings/light/08.png" alt="pill-all" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill-all">
            ...
            <div class="d-grid gap-x-3 grid-cols-2">
              <div class="mb-4 text-center">
                <img src="../../resources/images/settings/dark/10.png" alt="image" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                <img src="../../resources/images/settings/light/10.png" alt="image" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="nav-glass">
                <span class="mt-2">Glass</span>
              </div>
              <div class="mb-4 text-center">
                 <img src="../../resources/images/settings/dark/11.png" alt="color" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                 <img src="../../resources/images/settings/light/11.png" alt="color" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar-header" data-name="navbar-type" data-value="navs-bg-color">
                <span class="mt-2">Color</span>
              </div>
              <div class="mb-4 text-center">
                 <img src="../../resources/images/settings/dark/12.png" alt="sticky" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                 <img src="../../resources/images/settings/light/12.png" alt="sticky" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-sticky">
                <span class="mt-2">Sticky</span>
              </div>
              <div class="mb-4 text-center">
                  <img src="../../resources/images/settings/dark/12.png" alt="transparent" class="mode dark-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
                  <img src="../../resources/images/settings/light/12.png" alt="transparent" class="mode light-img img-fluid btn-border p-0 flex-column" data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type" data-value="navs-transparent">
