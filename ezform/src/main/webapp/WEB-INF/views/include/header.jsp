...
<!-- Fullcalender CSS -->
<link rel='stylesheet'
	href='${pageContext.request.contextPath }/resources/vendor/fullcalendar/core/main.css' />
<link rel='stylesheet'
	href='${pageContext.request.contextPath }/resources/vendor/fullcalendar/daygrid/main.css' />
<link rel='stylesheet'
								  ...
								  7.9635L13.943 2.67427C12.7785 1.74912 11.1154 1.77901
								   ...
								   9.11956 2.5 9.86585V18.5686C2.5 20.4637 4.04738 22 5.95617
								    22H7.87229C8.19917 22.0023 8.51349 21.8751 8.74547 21.6464C8.97746
								     21.4178 9.10793 21.1067 9.10792 20.7821H9.14373Z" fill="currentColor">
							</path></svg>                            
						</i> <span class="item-name">홈</span>
					</a></li>
		...
		<!------------------------------------------------------- Pages 영역 ------------------------------------------------------------->
						...
						<a class="nav-link " href="./dashboard/table/table-data.html"> 
							<i class="icon"> 
                            	<svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            	    ...
                            	    <circle cx="12" cy="12" r="3" fill="#130F26"></circle></mask>                                    
                            	    <circle opacity="0.53" cx="13.5" cy="10.5" r="1.5" fill="white"></circle>
                            	</svg>                                                                                                                                                              
							</i>
							<span class="item-name">출퇴근</span>
						</a>
					</li>
					...
					<li class="nav-item"><a class="nav-link"
						...
						<ul class="sub-nav collapse" id="sidebar-user"
							...
							<li class="nav-item"><a class="nav-link "
								href="/test/ez_mail/impMail"> <i class="icon">
										<svg xmlns="http://www.w3.org/2000/svg" width="10"
											viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                            <circle cx="12" cy="12"
					...
					<li class="nav-item">
						<a class="nav-link " href="/test/calendar"> 
							<i class="icon"> 
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<li class="nav-item static-item"><a
						class="nav-link static-item disabled" href="#" tabindex="-1">
							<span class="default-icon">Contact</span> <span
							class="mini-icon">-</span>
					</a></li>
					
					<!---------------------------------- 사이드메뉴 : 커뮤니티 게시판 ----------------------------------->
					<li class="nav-item">
						<a class="nav-link" href="/test/board/listPage">
							<i class="icon">
					...
					<!---------------------------------- 사이드메뉴 : 공지사항 ---------------------------------------------->
					<li class="nav-item">
						<a class="nav-link " href="/test/ez_notice/listAll"> 
							<i class="icon"> 
                            	<svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="card-body p-0 ">
											<a href="#" class="iq-sub-card">
												<div class="d-flex  align-items-center">
													<div class="">
														<img class="avatar-40 rounded-pill bg-soft-primary p-1"
															src="${pageContext.request.contextPath }/resources/images/shapes/01.png" alt="">
													</div>
													<div class="ms-3">
												...
												<div class="d-flex align-items-center">
													<div class="">
														<img class="avatar-40 rounded-pill bg-soft-primary p-1"
															src="${pageContext.request.contextPath }/resources/images/shapes/02.png" alt="">
													</div>
													<div class="ms-3">
												...
												<div class="d-flex align-items-center">
													<div class="">
														<img class="avatar-40 rounded-pill bg-soft-primary p-1"
															src="${pageContext.request.contextPath }/resources/images/shapes/03.png" alt="">
													</div>
													<div class="ms-3">
												...
												<div class="d-flex align-items-center">
													<div class="">
														<img class="avatar-40 rounded-pill bg-soft-primary p-1"
															src="${pageContext.request.contextPath }/resources/images/shapes/04.png" alt="">
													</div>
													<div class="ms-3">
												...
												<div class="d-flex align-items-center">
													<div class="">
														<img class="avatar-40 rounded-pill bg-soft-primary p-1"
															src="${pageContext.request.contextPath }/resources/images/shapes/05.png" alt="">
													</div>
													<div class="ms-3">
...
<!-- ----------------------------------------------------- 로그인/회원정보/로그아웃 영역 ------------------------------------------------- -->						
			...
			<div class="iq-navbar-header" style="height: 105px;">
				...
				<div class="iq-header-img">
					<img src="${pageContext.request.contextPath }/resources/images/dashboard/top-header.png" alt="header"
