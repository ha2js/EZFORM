...
--
-- Table structure for table `ez_work`
--

DROP TABLE IF EXISTS `ez_work`;
...
--
-- Dumping data for table `ez_work`
--

LOCK TABLES `ez_work` WRITE;
/*!40000 ALTER TABLE `ez_work` DISABLE KEYS */;
/*!40000 ALTER TABLE `ez_work` ENABLE KEYS */;
UNLOCK TABLES;
